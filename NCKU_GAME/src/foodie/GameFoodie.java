...
public class GameFoodie extends JFrame{
	...
	public void launch() {
		loadBGM("sound/veryGoodSong.wav");
		playBGM();
	...
	private void showRules() {
	    ...
	    rulesTextArea.setForeground(new Color(101-70, 67-50, 33-20));
	    rulesTextArea.setBackground(new Color(210, 180, 140)); 
